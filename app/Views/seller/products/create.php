...
<div class="flex flex-col gap-6">
    <div class="flex items-center justify-between">
        <div>
            ...
            <p class="text-base-content/50 text-sm mt-1">Fill in the details below to list your product for sale</p>
        </div>
                    ...
                    <div class="card-body p-6 gap-4">
                        ...
                        >
                            <div
                                ...
                                class="absolute inset-0 flex flex-col items-center justify-center gap-2 gap-4"
                            >
                            ...
                            <img id="preview-img" class="hidden w-full object-cover" alt="Product preview" />

                            <div
                                id="preview-overlay"
                                class="hidden absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center"
                            >
                ...
                <div class="card bg-base-100 border border-base-300 shadow-xl rounded-3xl overflow-hidden">
                    <div class="card-body p-6 gap-4">
                        ...
                        <p class="text-xs text-center text-base-content/30">
                            You can edit or unpublish this product anytime
                        </p>
                    </div>
                </div>
            </div>

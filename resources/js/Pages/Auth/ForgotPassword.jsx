                ...
                <div className='p-6 space-y-4 sm:p-8'>
                    ...
                    <form className='space-y-4 md:space-y-6 mt-6' onSubmit={handleSubmit}>
                        <div>
                            ...
                            <p className='text-sm font-light mt-4 text-right text-gray-500 dark:text-gray-400'>
                                <Link href={route("login")} className='font-medium text-blue-600 hover:underline'>Go back to login</Link>
                            </p>
                        </div>
                    </form>
                </div>
